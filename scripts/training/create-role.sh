...
ROLE_NAME="mlops-n1-training-role"
INSTANCE_PROFILE_NAME="mlops-n1-training-profile"
POLICY_NAME="MLOpsN1TrainingPolicy"
...
ROLE_POLICY="$PROJECT_ROOT/iam/training-role-policy.json"
